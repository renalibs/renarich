...
namespace rena {
    ...
    class fcolor {
        ...
        public:
            ...
            static constexpr _color_code BLACK = { 30 , 0x0000 , builtin::ColorCodeTypeForegroundColor };
            static constexpr _color_code RED = { 31 , 0x0004 , builtin::ColorCodeTypeForegroundColor };
            static constexpr _color_code GREEN = { 32 , 0x0002 , builtin::ColorCodeTypeForegroundColor };
            static constexpr _color_code YELLOW = { 33 , 0x0006 , builtin::ColorCodeTypeForegroundColor };
            static constexpr _color_code BLUE = { 34 , 0x0001 , builtin::ColorCodeTypeForegroundColor };
            static constexpr _color_code MAGENTA = { 35 , 0x0005 , builtin::ColorCodeTypeForegroundColor };
            static constexpr _color_code CYAN = { 36 , 0x0003 , builtin::ColorCodeTypeForegroundColor };
            static constexpr _color_code WHITE = { 37 , 0x0007 , builtin::ColorCodeTypeForegroundColor };
            static constexpr _color_code GRAY = { 90 , 0x0008 , builtin::ColorCodeTypeForegroundColor };
            static constexpr _color_code BRIGHTRED = { 91 , 0x000C , builtin::ColorCodeTypeForegroundColor };
            static constexpr _color_code BRIGHTGREEN = { 92 , 0x000A , builtin::ColorCodeTypeForegroundColor };
            static constexpr _color_code BRIGHTYELLOW = { 93 , 0x000E , builtin::ColorCodeTypeForegroundColor };
            static constexpr _color_code BRIGHTBLUE = { 94 , 0x0009 , builtin::ColorCodeTypeForegroundColor };
            static constexpr _color_code BRIGHTMAGENTA = { 95 , 0x000D , builtin::ColorCodeTypeForegroundColor };
            static constexpr _color_code BRIGHTCYAN = { 96 , 0x000B , builtin::ColorCodeTypeForegroundColor };
            static constexpr _color_code BRIGHTWHITE = { 97 , 0x000F , builtin::ColorCodeTypeForegroundColor };
    ...
    class bcolor {
        ...
        public:
            ...
            static constexpr _color_code BLACK = { 40 , 0x0000 , builtin::ColorCodeTypeBackgroundColor };
            static constexpr _color_code RED = { 41 , 0x0040 , builtin::ColorCodeTypeBackgroundColor };
            static constexpr _color_code GREEN = { 42 , 0x0020 , builtin::ColorCodeTypeBackgroundColor };
            static constexpr _color_code YELLOW = { 43 , 0x0060 , builtin::ColorCodeTypeBackgroundColor };
            static constexpr _color_code BLUE = { 44 , 0x0010 , builtin::ColorCodeTypeBackgroundColor };
            static constexpr _color_code MAGENTA = { 45 , 0x0050 , builtin::ColorCodeTypeBackgroundColor };
            static constexpr _color_code CYAN = { 46 , 0x0030 , builtin::ColorCodeTypeBackgroundColor };
            static constexpr _color_code WHITE = { 47 , 0x0070 , builtin::ColorCodeTypeBackgroundColor };
            static constexpr _color_code GRAY = { 100 , 0x0080 , builtin::ColorCodeTypeBackgroundColor };
            static constexpr _color_code BRIGHTRED = { 101 , 0x00C0 , builtin::ColorCodeTypeBackgroundColor };
            static constexpr _color_code BRIGHTGREEN = { 102 , 0x00A0 , builtin::ColorCodeTypeBackgroundColor };
            static constexpr _color_code BRIGHTYELLOW = { 103 , 0x00E0 , builtin::ColorCodeTypeBackgroundColor };
            static constexpr _color_code BRIGHTBLUE = { 104 , 0x0090 , builtin::ColorCodeTypeBackgroundColor };
            static constexpr _color_code BRIGHTMAGENTA = { 105 , 0x00D0 , builtin::ColorCodeTypeBackgroundColor };
            static constexpr _color_code BRIGHTCYAN = { 106 , 0x00B0 , builtin::ColorCodeTypeBackgroundColor };
            static constexpr _color_code BRIGHTWHITE = { 107 , 0x00F0 , builtin::ColorCodeTypeBackgroundColor };
